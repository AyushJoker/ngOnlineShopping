...
export class RetailerService {
  ...
  Updateretailer(ret: Retailer): Observable<any> {
    ...
    return this.http.put<any>(this.url + "/updateretailer/" + ret.rid, ret, this.httpOptions).pipe(catchError(this.handleError));
  ...
  AvailableRetailer(ret: Retailer): Observable<any> {
    return this.http.put<any>(this.url + "/isavailable/" + ret.rid, ret, this.httpOptions).pipe(catchError(this.handleError));
  }
